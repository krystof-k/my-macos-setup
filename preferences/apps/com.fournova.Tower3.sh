...
/usr/libexec/PlistBuddy -c 'Delete :"NSToolbar Configuration MainWindowToolbar.BigSur":"TB Display Mode"' ~/Library/Preferences/com.fournova.Tower3.plist 2>/dev/null || true
...
/usr/libexec/PlistBuddy -c 'Delete :"NSToolbar Configuration MainWindowToolbar.BigSur":"TB Item Identifiers"' ~/Library/Preferences/com.fournova.Tower3.plist 2>/dev/null || true
